...
exports.listSortingRecords=onRequest({region:"asia-northeast3",cors:false},createListSortingRecordsHandler({store:queryStore,allowTestActor:process.env.FUNCTIONS_EMULATOR==="true"}));
exports.resolveSortingRecord=onRequest({region:"asia-northeast3",cors:false},createResolveSortingRecordHandler({store:queryStore,allowTestActor:process.env.FUNCTIONS_EMULATOR==="true",serverTimestamp:()=>FieldValue.serverTimestamp()}));
