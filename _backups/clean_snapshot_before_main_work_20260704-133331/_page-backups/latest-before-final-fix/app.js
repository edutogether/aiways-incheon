(() => {
  ...
  function initNavigation() {
    ...
    const initial = window.location.hash ? document.getElementById(window.location.hash.slice(1)) : sections[0];
    activate(initial || sections[0]);
  }
  // PAGE_FIX_COMMON_END
