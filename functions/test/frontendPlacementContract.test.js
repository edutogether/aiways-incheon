...
const nav = ["대시보드", "프로젝트", "교육과정", "H-A-H", "차시흐름", "갤러리", "자료실"];
const sections = ["dashboard", "project", "curriculum", "hah", "flow", "gallery", "resources"];
...
test("major content remains in its original section", () => {
  const expected = {
    ...
    resources: ["resource-grid", "footer-credit"]
  };
