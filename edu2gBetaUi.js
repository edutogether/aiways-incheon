...
(() => {
  ...
  function build() {
    ...
    const heading = document.createElement("div"), kicker = document.createElement("p"), title = document.createElement("h2"); kicker.className = "edu2g-beta-kicker"; text(kicker, "DEVICE"); title.id = "edu2g-beta-title"; text(title, "내 기기 연결"); heading.append(kicker, title);
