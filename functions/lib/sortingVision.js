...
function createAnalyzeSortingHandler(dependencies = {}) {
  ...
  return async (req, res) => {
    ...
    try {
      ...
      if (!responseCheck.valid) return res.status(502).json(errorResponse("invalid_model_response", requestCheck.requestId));
...
module.exports = { RESPONSE_SCHEMA, isAllowedOrigin, createGeminiClient, analyzeWithGemini, createAnalyzeSortingHandler };
